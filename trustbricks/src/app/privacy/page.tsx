      ...
      <main className="flex-grow pt-32 pb-24">
        <section className="max-w-3xl mx-auto px-6 lg:px-8">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-10 border border-slate-200/60 shadow-card space-y-6 text-[#475569] text-sm leading-relaxed">
            ...
            <h2 className="text-xl font-bold text-[#0D1F3C] pt-2" style={{ fontFamily: "var(--font-display)" }}>1. Information We Collect</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-[#0D1F3C] pt-2" style={{ fontFamily: "var(--font-display)" }}>2. How We Use Your Information</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-[#0D1F3C] pt-2" style={{ fontFamily: "var(--font-display)" }}>3. Information Sharing and Disclosure</h2>
            <p>
            ...
            <h2 className="text-xl font-bold text-[#0D1F3C] pt-2" style={{ fontFamily: "var(--font-display)" }}>4. Security</h2>
            <p>
