...
export async function processMortgageLead(formData: FormData): Promise<LeadResponse> {
  try {
    ...
    try {
      const recipientEmail = process.env.NOTIFICATION_EMAIL || 'csu@trustbrickpropertieslimited.com.ng';
      if (process.env.SMTP_USER && process.env.SMTP_PASS) {
        ...
        console.log(`[ROUTING ENGINE] Notification email sent to ${recipientEmail}`);
      } else {
