        ...
        <section className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-black text-[var(--color-text-heading)] mb-6" style={{ fontFamily: "var(--font-display)" }}>
              Latest News & <br />
              <span className="text-[var(--color-clay-500)]">Announcements.</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {ARTICLES.map((article, index) => (
              <motion.article
                ...
                className="bg-[var(--color-card)] rounded-3xl p-6 border border-[var(--color-border)] shadow-card hover:shadow-card-hover transition-all duration-300 flex flex-col justify-between"
              >
                <div className="space-y-4">
                  <div className="flex justify-between items-center text-xs">
                    <span className="font-bold text-[var(--color-clay-500)] uppercase tracking-wider bg-[var(--color-clay-500)]/5 px-2.5 py-1 rounded-md">
                      {article.category}
                    </span>
                  ...
                  <h3 className="text-lg font-bold text-[var(--color-text-heading)] leading-snug line-clamp-3 hover:text-[var(--color-clay-500)] cursor-pointer transition-colors" style={{ fontFamily: "var(--font-display)" }}>
                    {article.title}
                  </h3>
