      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p
            ...
            style={{ fontFamily: "var(--font-display)", color: "var(--color-amber-500)" }}
          >
            4 State Offices
          </p>
          <h2
        ...
        >
          {OFFICES.map((office) => (
            <motion.button
              ...
              className="relative flex flex-col items-center gap-2 px-4 py-6 rounded-2xl border-2 transition-all duration-[220ms] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#E8600A]"
              style={{
                borderColor:
            ...
            >
              ...
              <span className="text-3xl" aria-hidden="true">{office.emoji}</span>
              <span
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr_auto_1fr]">
              {/* Address */}
              <DetailBlock label="Office Address" icon="📍">
                <p
              ...
              {/* Contact */}
              <DetailBlock label="Contact" icon="📞">
                <a
                  href={`tel:${active.phone.replace(/\s/g, "")}`}
                  className="block text-sm font-semibold mb-1 hover:underline"
                  style={{ fontFamily: "var(--font-display)", color: "var(--color-navy-700)" }}
                >
                  {active.phone}
                </a>
                <a
              ...
              {/* Actions */}
              <DetailBlock label="Quick Actions" icon="⚡">
                <div className="flex flex-col gap-2">
                  <motion.a
                    href={`https://wa.me/${active.whatsapp}?text=${encodeURIComponent(
                      `Hello, I'd like to speak with a Trust Brick Properties advisor at your ${active.city} office.`
                    )}`}
                    target="_blank"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold border transition-colors duration-[180ms] hover:border-[var(--color-navy-700)] hover:text-[var(--color-navy-700)]"
                    style={{
                      fontFamily: "var(--font-display)",
                      borderColor: "var(--color-border)",
