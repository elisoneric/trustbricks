  ...
  return (
    <header
      ...
      className={[
        ...
        scrolled
          ? "top-4 left-4 right-4 md:left-1/2 md:right-auto md:-translate-x-1/2 md:w-[90%] md:max-w-5xl rounded-2xl bg-white/90 backdrop-blur-[16px] saturate-[1.8] border border-slate-200/60 shadow-[0_8px_32px_rgba(13,31,60,0.08)]"
    ...
    >
      ...
      >
        ...
        <Link
          href="/"
          className="flex items-center gap-2.5 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-amber-500)] rounded-md"
          aria-label="Trust Brick Properties — home"
        >
          {/* Brick icon */}
          <span
            aria-hidden="true"
            className="flex items-center justify-center w-9 h-9 rounded-[8px] bg-[var(--color-navy-700)] text-white text-xs font-black leading-none select-none"
          ...
          <span
            ...
            style={{ fontFamily: "var(--font-display)" }}
          >
            <span className="block text-[11px] font-semibold tracking-[0.12em] uppercase text-[var(--color-amber-500)]">
              Trust Brick
            </span>
            <span className="block text-[13px] font-black text-[var(--color-navy-700)] tracking-tight">
              PROPERTIES LTD
            </span>
          </span>
        </Link>
          ...
          {NAV_LINKS.map((link) => (
            <li key={link.href}>
              <Link
                ...
                className={[
                  "relative px-3 py-1.5 text-sm font-medium text-slate-900 cursor-pointer",
                  "transition-colors duration-[300ms] hover:text-[var(--color-amber-500)]",
                  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-amber-500)] rounded",
                  "after:content-[''] after:absolute after:bottom-0 after:left-3 after:right-3 after:h-[2px]",
                  "after:bg-[var(--color-amber-500)] after:scale-x-0 after:origin-left",
        ...
        <div className="hidden md:flex items-center gap-3">
          <motion.a
            ...
            className={[
              ...
              "shadow-[var(--shadow-action-glow)] hover:shadow-[0_0_32px_rgba(232,96,10,0.6)]",
        ...
        <button
          ...
          className={[
            ...
            "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-amber-500)]",
          ].join(" ")}
        ...
        >
          {([
            ...
            <motion.span
              ...
              className="block w-6 h-[2px] bg-[var(--color-navy-700)] rounded-full origin-center"
              aria-hidden="true"
            />
          ))}
        </button>
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="md:hidden overflow-hidden bg-[var(--color-navy-700)] border-t border-[rgba(255,255,255,0.08)]"
            role="navigation"
              ...
              <motion.li variants={drawerItemVariants} className="mt-3">
                <a
                  ...
                  className={[
                    ...
                    "bg-[var(--color-amber-500)] text-white font-bold text-base",
