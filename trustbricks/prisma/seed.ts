...
async function main() {
  ...
  const branches = [
    ...
    { name: 'Adamawa', email: 'adamawa@trustbrickproperties.ng', whatsapp: '+2349136881719', phone: '09136881719', city: 'Yola', state: 'Adamawa', address: 'Abdullahi Bashir Road, Dougerei', landmark: 'Dougerei' },
