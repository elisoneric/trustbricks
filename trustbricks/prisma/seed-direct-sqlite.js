// Standalone SQLite direct script for website database (supports both local file:./dev.db and production file:/app/data/dev.db)
...
async function syncProductionDb() {
  ...
  console.log(`Successfully synced ${pfas.length} PFA rules.`);
}
